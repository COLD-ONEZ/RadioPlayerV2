...
RUN wget -q https://github.com/DarkAngel1234-tech/RadioPlayerV2/archive/Dark_Angel.tar.gz && tar xf Dark_Angel.tar.gz && rm Dark_Angel.tar.gz

WORKDIR /RadioPlayerV2-Dark_Angel
CMD python3 main.py
