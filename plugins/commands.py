...
async def start(client, message):
    buttons = [
        [
        InlineKeyboardButton('⚡️Master⚡️', url='https://t.me/DARK_ANGEL_1234'),
        InlineKeyboardButton('Help ⚙️', callback_data='help'),
    ],
    [
        InlineKeyboardButton('🗣️Any Doubt', url='https://t.me/Mo_Tech_Group'),
        InlineKeyboardButton('Bot Updates🔊', url='https://telegram.me/Mo_Tech_YT'),
    ]
    ]
